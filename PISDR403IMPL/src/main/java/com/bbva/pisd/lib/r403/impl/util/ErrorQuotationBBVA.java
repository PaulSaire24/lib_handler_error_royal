...
public enum ErrorQuotationBBVA {
    ...
    BBVA00123465("BBVA00123465","No existe el valor de equivalencia para el tipo de documento enviado.","wrong"),
    ...
    BBVA00123472("BBVA00123472","El campo apePaterno de persona en su elemento 1 debe contener como máximo 30 caracteres","wrong"),
